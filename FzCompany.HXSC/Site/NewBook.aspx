<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewBook.aspx.cs" Inherits="FzCompany.HXSC.Site.NewBook" %>
...
<body>
    ...
    <div class="content">
        ...
        <div class="w970 fleft">
            <div class="savetitle-titile">
                <h3 class="col-wi50 fleft m10">新书上架</h3>
                <span class="fright mp10"></span>
            </div>

            <!--begin-->

            <div class=" notoptab" id="list">
    ...
    <script>
        $(function () {
            var model = ' <table border="0" class="fl w480"><tr><td width="13%" rowspan="8"><img src="_%imageurl%_"></td><td><strong>_%bookname%_</strong><span class="pjx"></span><span class="pjx"></span><span class="pjx"></span><span class="pjx"></span></td></tr><tr><td>_%bookremark%_</td></tr><tr><td>_%remark1%_</td></tr><tr><td>_%remark2%_</td></tr><tr><td>&nbsp;</td></tr><tr><td>&nbsp;</td></tr><tr><td>&nbsp;</td></tr><tr><td>_%bookprice%_</td></tr></table>';
            var list = $("#list");
            var param = {
                pageindex: 1,
                pagesize: 10
            }
            ajaxsend(2012, toQueryString(param), function (response) {
                if (response.ErrorCode == 0) {
                    var data = response.PackData;
                    var info = "";
                    $.each(data.List, function (i, d) {
                        info += model.list.replace(/_%imageurl%_/g, "").replace(/_%bookname%_/g, "").replace(/_%bookremark%_/g, "").replace(/_%remark1%_/g, "").replace(/_%remark2%_/g, "").replace(/_%bookprice%_/g, "");
                    });
                    list.html(info);
                }
            });
