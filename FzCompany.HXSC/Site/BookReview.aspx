<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookReview.aspx.cs" Inherits="FzCompany.HXSC.Site.BookReview" %>
...
<body>
    ...
    <div class="content corl_lind ">
        <div class="fleft col-wi50">
            <ul class="list-inline pull-textlp5"><a href="javascript:void(0);">收藏本站</a></ul>
        </div>
        <div class=" fright">
    ...
    <div class="content">
        ...
        <div class="w970 fleft">
            <div class="savetitle-titile">
                <h3 class="col-wi50 fleft m10">书评广场</h3>
                <span class="fright mp10"></span></div>
            ...
            <div class="page mt10 fright">
                <div class="pagebtn"><a href="#">上一页</a></div>
                <div class="pagebtntxt orange">1</div>
                <div class="pagebtntxt">2</div>
                <div class="pagebtn"><a href="#">下一页</a></div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            var model = '<tr><td width="11%" rowspan="3"><img src="_%imageurl%_"></td><td colspan="2"><strong>_%bookname%_</strong></td></tr><tr><td colspan="2"><span class="pjx"></span><span class="pjx"></span><span class="pjx"></span><span class="pjx"></span></td></tr><tr><td colspan="2">_%bookreview%_</td></tr><tr><td width="11%" class="context-center">_%bookname%_</td><td width="74%" class="orange">&nbsp;</td><td width="15%"><img src="images/month/icon_pl.jpg" />0<img src="images/month/icon_pl2.jpg">0</td></tr><tr><td colspan="3">&nbsp;</td></tr><tr><td colspan="3" class="notopbottom">&nbsp;</td></tr>';
            ...
            ajaxsend(0001, toQueryString(param), function(response) {
                if (response.ErrorCode == 0) {
                    var data = response.PackData;
                    var info = "";
                    $.each(data.List, function (i, d) {
                        info += model.list.replace(/_%imageurl%_/g, "").replace(/_%bookname%_/g, "").replace(/_%bookreview%_/g, "");
                    });
                    list.html(info);
                }
            });
